...
public class AccountPage extends BasePage {
    ...
    private static final By DETAILS_TAB_PANEL = By.xpath("//div[@records-recordlayoutsection_recordlayoutsection " +
            "and contains(@class,'slds-form')]//@slot/ancestor::div[@class='slds-form-element__control']");
