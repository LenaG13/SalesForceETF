...
public class AccountDetailsComponent extends AbstractComponent {
    ...
    public static final String ACCOUNTS_TEXT_DATA_FIELD = "//div[contains(@class,'slds-tabs_card')]" +
        ...
        /*"//div[@class='slds-tabs_card']//span[text()='%s']/ancestor::div[@records-recordlayoutitem_recordlayoutitem " +
        "and contains(@class,'label-inline')]//slot[@name='outputField']//lightning-formatted-%s";*/
